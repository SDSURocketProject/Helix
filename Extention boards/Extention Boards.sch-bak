...
RESERVED1
$Sheet
S 3750 5050 1150 2350
U 5D27F062
F0 "Sensors" 60
F1 "Sensors.sch" 60
F2 "ADS1247_SCLK" I R 4900 5150 60 
F3 "ADS1247_DIN" I R 4900 5350 60 
F4 "ADS1247_DOUT" I R 4900 5250 60 
F5 "~ADS1247_DRDY" I R 4900 5550 60 
F6 "~ADS1247_CS" I R 4900 5450 60 
F7 "ADS1247_START" I R 4900 5650 60 
F8 "ADS1247_CHSEL_S1" I R 4900 5850 60 
F9 "ADS1247_CHSEL_S0" I R 4900 5750 60 
F10 "HE_CH0" I R 4900 7100 60 
F11 "HE_CH1" I R 4900 7200 60 
F12 "PWR_CH3_HE" I R 4900 6450 60 
F13 "PWR_CH0_PT" I R 4900 6150 60 
F14 "PWR_CH1_PT" I R 4900 6250 60 
F15 "PWR_CH4_HE" I R 4900 6550 60 
F16 "PWR_CH2_PT" I R 4900 6350 60 
F17 "PWR_CH5_HE" I R 4900 6650 60 
F18 "HE_CH2" I R 4900 7300 60 
$EndSheet
...
F5 "PWR_CH1_EN" I R 4850 2100 60 
F6 "PWR_CH1" I R 4850 2000 60 
F7 "~PWR_CH1_CURR_OVLD" I R 4850 2200 60 
F8 "PWR_CH2" I R 4850 2500 60 
F9 "~PWR_CH2_CURR_OVLD" I R 4850 2700 60 
F10 "PWR_CH2_EN" I R 4850 2600 60 
F11 "PWR_CH3" I R 4850 3000 60 
F12 "~PWR_CH3_CURR_OVLD" I R 4850 3200 60 
F13 "PWR_CH3_EN" I R 4850 3100 60 
F14 "PWR_CH4" I R 4850 3500 60 
F15 "PWR_CH4_EN" I R 4850 3600 60 
F16 "~PWR_CH4_CURR_OVLD" I R 4850 3700 60 
F17 "PWR_CH5" I R 4850 4000 60 
F18 "PWR_CH5_EN" I R 4850 4100 60 
F19 "~PWR_CH5_CURR_OVLD" I R 4850 4200 60 
F20 "VCC_SENS" I R 4850 4500 60 
F21 "VCC_CURR_SENSE" I R 4850 4600 60 
F22 "PWR_CH5_CURR_SENS" I R 4850 4300 60 
F23 "PWR_CH4_CURR_SENS" I R 4850 3800 60 
F24 "PWR_CH3_CURR_SENS" I R 4850 3300 60 
F25 "PWR_CH2_CURR_SENS" I R 4850 2800 60 
F26 "PWR_CH1_CURR_SENS" I R 4850 2300 60 
F27 "PWR_CH0_CURR_SENS" I R 4850 1800 60 
$EndSheet
...
PWR_CH5_CURR_SENSE
$Sheet
S 8000 1900 1150 4000
U 5D27F055
F0 "MCU" 60
F1 "MCU.sch" 60
F2 "ADS1247_DOUT" I L 8000 2800 60 
F3 "~ADS1247_CS" I L 8000 3000 60 
F4 "ADS1247_DIN" I L 8000 2900 60 
F5 "ADS1247_SCLK" I L 8000 2700 60 
F6 "~ADS1247_DRDY" I L 8000 3100 60 
F7 "ADS1247_START" I L 8000 3200 60 
F8 "ADS1247_CHSEL_S1" I L 8000 3400 60 
F9 "ADS1247_CHSEL_S0" I L 8000 3300 60 
F10 "HE_CH0" I L 8000 3900 60 
F11 "HE_CH1" I L 8000 4000 60 
F12 "PWR_CH0_EN" I L 8000 4300 60 
F13 "PWR_CH1_EN" I L 8000 4400 60 
F14 "PWR_CH2_EN" I L 8000 4500 60 
F15 "PWR_CH3_EN" I L 8000 4600 60 
F16 "HE_CH2" I L 8000 4100 60 
F17 "PWR_CH4_EN" I L 8000 4700 60 
F18 "PWR_CH5_EN" I L 8000 4800 60 
F19 "~PWR_CH0_CURR_OVLD" I L 8000 2000 60 
F20 "~PWR_CH1_CURR_OVLD" I L 8000 2100 60 
F21 "~PWR_CH2_CURR_OVLD" I L 8000 2200 60 
F22 "~PWR_CH3_CURR_OVLD" I L 8000 2300 60 
F23 "~PWR_CH4_CURR_OVLD" I L 8000 2400 60 
F24 "~PWR_CH5_CURR_OVLD" I L 8000 2500 60 
F25 "CANH1" I L 8000 3600 60 
F26 "CANL1" I L 8000 3700 60 
F27 "PWR_CH0_CURR_SENSE" I L 8000 5000 60 
F28 "PWR_CH1_CURR_SENSE" I L 8000 5100 60 
F29 "PWR_CH2_CURR_SENSE" I L 8000 5200 60 
F30 "PWR_CH3_CURR_SENSE" I L 8000 5300 60 
F31 "PWR_CH4_CURR_SENSE" I L 8000 5400 60 
F32 "PWR_CH5_CURR_SENSE" I L 8000 5500 60 
F33 "VCC_SENSE" I L 8000 5700 60 
F34 "VCC_CURR_SENSE" I L 8000 5800 60 
$EndSheet
